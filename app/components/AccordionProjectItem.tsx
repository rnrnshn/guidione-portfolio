...
export const AccordionProjectItem = ({ title, children, isActive, onToggle }) => {
  ...
  return (
    <div className="flex flex-col">
      <button
        className={`max-w-5xl sm:ml-40 flex justify-between items-center w-full sm:p-4 py-4 text-left focus:outline-none transition-all duration-300 ease-in-out ${isActive ? '' : 'border-b border-gray-200'
          }`}
        onClick={onToggle}
